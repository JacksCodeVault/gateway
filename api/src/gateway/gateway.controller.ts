...
export class GatewayController {
  ...
  @Patch('/devices/:id')
  async updateDevice(@Param('id') deviceId: string, @Body() input: RegisterDeviceInputDTO) {
  ...
  async sendSMS(@Param('id') deviceId: string, @Body() smsData: SendSMSInputDTO) {
  ...
  async getReceivedSMS(@Param('id') deviceId: string): Promise<RetrieveSMSResponseDTO> {
