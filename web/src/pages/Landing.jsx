...
import { ArrowRight, MessageSquare, Shield, Zap, Users, Database, Smartphone } from "lucide-react"
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 pt-24">
        <section className="py-12 md:py-24">
          ...
          >
            ...
            <p className="mt-4 md:mt-6 text-base md:text-lg leading-7 md:leading-8 text-muted-foreground max-w-2xl mx-auto">
              A powerful, scalable, and easy-to-use SMS gateway solution that
              puts you in control of your messaging infrastructure.
            </p>
            <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/JacksCodeVault/gateway",
                    "_blank"
                  )
                }
              >
        ...
        <section className="py-12 md:py-24">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Join our thriving community of developers. OpenSMS Gateway is
              free, open source, and welcomes contributions from developers
              worldwide.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            ...
            >
              ...
              <p className="mt-2 text-sm md:text-base text-muted-foreground">
                Ensure your messages are delivered with our robust
                infrastructure and fallback mechanisms.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="mt-2 text-sm md:text-base text-muted-foreground">
                High-performance architecture designed for speed and
                scalability.
              </p>
            </motion.div>
          </div>
        ...
        <section className="py-12 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <Database className="h-10 w-10 md:h-12 md:w-12 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2">
                Firebase Integration
              </h3>
              <p className="text-muted-foreground">
                Firebase Cloud Messaging (FCM) enables real-time communication
                between web and mobile devices.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="rounded-lg border p-6"
            >
              <MessageSquare className="h-10 w-10 md:h-12 md:w-12 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2">SMS Sending</h3>
              <p className="text-muted-foreground">
                Complete SMS sending flow from web interface to mobile device
            ...
            <motion.div
              ...
              className="rounded-lg border p-6"
            >
              <Smartphone className="h-10 w-10 md:h-12 md:w-12 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2">Device Management</h3>
              <p className="text-muted-foreground">
                Register and manage multiple devices with real-time status
            ...
            >
              ...
              <p className="text-muted-foreground">
                Instant synchronization of messages and device status through
        ...
        <section className="py-12 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Free to use, modify, and distribute under MIT license. Full
            ...
            >
              ...
              <p className="text-muted-foreground">
                Keep full control of your data by hosting on your own
